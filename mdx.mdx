...
The reason is that they can be indistinguishable from JSX (for example: `<svg:rect>`) and we prefer being explicit.

If you want links, use full links: [descriptive text](https://and-the-link-here.com)
